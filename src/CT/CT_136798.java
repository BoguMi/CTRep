...
public class CT_136798 {
     ...
     * 이웃나라와 협약으로 정해진 공격력의 제한수치를 나타내는 정수 limit와 제한수치를 초과한 기사가 사용할 무기의 공격력을 나타내는 정수 power가 주어졌을 때,
    ...
    public static void main(String[] args) {
        System.out.println("sol1: " + solution(5,3,2));
    }
